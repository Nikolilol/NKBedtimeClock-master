#
#  Be sure to run `pod spec lint NKBedtimeClock.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Nikolilol"
  # s.authors            = { "Nikolilol" => "nikoli_89@163.com" }
  # s.social_media_url   = "http://twitter.com/Nikolilol"
